...
const HeroCyberpunk = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden hero-cyberpunk-bg">
      ...
      {/* Diagonal energy streaks - right side */}
      ...
      <div className="absolute top-[30%] left-[15%] w-3 h-3 rounded-full bg-[#2FF3E0]/40 animate-orbit pointer-events-none" />
      <div className="absolute top-[50%] right-[20%] w-2 h-2 rounded-full bg-[#FF2FB3]/30 animate-orbit pointer-events-none" style={{ animationDelay: '-5s' }} />
      
      {/* Floating particles */}
      <div className="absolute top-[40%] left-[25%] w-1 h-1 rounded-full bg-[#2FF3E0]/60 animate-float-particle" />
      <div className="absolute top-[60%] right-[30%] w-1.5 h-1.5 rounded-full bg-[#FF2FB3]/40 animate-float-particle" style={{ animationDelay: '-2s' }} />
        ...
        <div className="max-w-3xl">
          ...
          <motion.div
            ...
            <div className="inline-flex items-center gap-2.5 glass-pill rounded-full px-4 py-2 mb-8">
              ...
              <span className="w-1.5 h-1.5 rounded-full bg-[#2FF3E0]" />
            </div>
          </motion.div>
          ...
          <motion.h1
            ...
            with Brands
            <br />
            <span className="hero-heading-italic text-white/95">
          ...
          <motion.div
            ...
            <div className="hidden sm:flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-[#2FF3E0]" />
      ...
      <motion.div
        ...
        <div className="glass-card rounded-2xl p-6">
          ...
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#2FF3E0]/20 to-[#FF2FB3]/20 flex items-center justify-center">
                <Sparkles className="w-4 h-4 text-[#2FF3E0]" />
              </div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-5">
            <div className="glass-pill rounded-xl p-3">
              <p className="text-xs text-white/50 mb-1">Active Gigs</p>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 glass-pill rounded-lg px-3 py-2">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#2FF3E0] to-[#0284C7] flex items-center justify-center text-xs font-bold text-white">
                A
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm text-white truncate">New submission received</p>
                <p className="text-xs text-white/50">2 min ago</p>
              </div>
              <div className="w-2 h-2 rounded-full bg-[#2FF3E0]" />
            </div>
            
            <div className="flex items-center gap-3 glass-pill rounded-lg px-3 py-2">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#FF2FB3] to-[#3B1A6B] flex items-center justify-center text-xs font-bold text-white">
                M
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm text-white truncate">Payment completed</p>
                <p className="text-xs text-white/50">5 min ago</p>
              </div>
              <div className="w-2 h-2 rounded-full bg-[#22C55E]" />
            </div>
          </div>
          ...
          <div className="mt-5">
            ...
            <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
              <div className="h-full w-[78%] bg-gradient-to-r from-[#2FF3E0] to-[#FF2FB3] rounded-full" />
            </div>
          </div>
        </div>
