  ...
  ref) =>
  {
    ...
    useEffect(() => {
      if (shouldLoad && autoPlay && videoRef.current) {
        ...
        {shouldLoad && <video ref={videoRef} src={src} poster={poster} autoPlay={autoPlay} muted={muted} loop={loop} playsInline={playsInline} onLoadedData={handleVideoLoaded} className={cn(
